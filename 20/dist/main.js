...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "15d72d489c72320b01a8";
...
/******/ 	deferredModules.push(["./src/index.js","styles","vendors~main"]);
...
/* harmony import */ var _js_number__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/number */ "./src/js/number.js");
...
Object(_js_number__WEBPACK_IMPORTED_MODULE_3__[/* number */ "a"])();
Object(_js_counter__WEBPACK_IMPORTED_MODULE_2__[/* counter */ "a"])();
Object(_js_sum__WEBPACK_IMPORTED_MODULE_0__[/* sumFunc */ "a"])();
/*
...
console.log(lodash__WEBPACK_IMPORTED_MODULE_4___default.a.join([0, 1, 2, 3], '***')); // 异步形式的代码加载
...
function counter() {
  ...
  div.innerHTML = Object(_sum__WEBPACK_IMPORTED_MODULE_0__[/* sumFunc */ "a"])();
  ;
...
/* harmony import */ var _sum_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sum.js */ "./src/js/sum.js");
/* harmony import */ var _css_number_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../css/number.css */ "./src/css/number.css");
/* harmony import */ var _css_number_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_css_number_css__WEBPACK_IMPORTED_MODULE_1__);
...
function number() {
  ...
  document.body.append(div);
  div.innerHTML = Object(_sum_js__WEBPACK_IMPORTED_MODULE_0__[/* sumFunc */ "a"])();
}
...
/*!***********************!*\
  !*** ./src/js/sum.js ***!
  \***********************/
/*! exports provided: sumFunc, getName, getPath, getUrl, formatDate, deepCopy, getStyle */
/*! exports used: sumFunc */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return sumFunc; });
...
function getStyle(element, attr, NumberMode = 'int') {
  let res; //  scrollTop 获取方式不同，因为它不属于style，属于DOM元素
  ...
  if (attr === 'scrollTop') {
    ...
    // document.defaultView更加严谨，指的是当前document对象所关联的window对象，如果没有则返回null
    //一般使用window.getComputedStyle(元素, 伪类)[属性名]
    res = document.defaultView.getComputedStyle(element, null)[attr];
  } //  在获取opacity的时候需要获取小数


  return NumberMode == 'float' ? _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_1___default()(res) : _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(res);
}
